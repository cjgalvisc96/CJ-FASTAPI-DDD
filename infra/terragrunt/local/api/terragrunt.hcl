...
include "envcommon" {
  path           = "${dirname(find_in_parent_folders("env.hcl"))}/../_envcommon/api.hcl"
  merge_strategy = "deep"
}
...
dependency "ecr" {
  ...
  mock_outputs = {
    repository_url  = "000000000000.dkr.ecr.us-east-1.amazonaws.com/cj-fastapi-ddd-dev-api"
    repository_arn  = "arn:aws:ecr:us-east-1:000000000000:repository/cj-fastapi-ddd-dev-api"
    repository_name = "cj-fastapi-ddd-dev-api"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan", "init"]
}
